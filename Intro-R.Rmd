...
```{r RStudio-window-1, echo = FALSE, out.width = "70%", fig.align = 'center', fig.cap = "The RStudio window when you first launch the program."}
knitr::include_graphics("images/RStudio-window-1.png")
```
...
```{r install-packages, echo = FALSE, out.width = "70%", fig.align = 'center', fig.cap = "A visual guide to installing R packages using the 'Tools' tab in RStudio."}
knitr::include_graphics("images/RStudio-window-install.png")
```
...
```{r load-data, echo = FALSE, out.width = "70%", fig.align = 'center', fig.cap = "A visual guide to loading a dataset into R using the 'Import Dataset' tab in RStudio."}
knitr::include_graphics("images/RStudio-window-data-1.png")
```

```{r load-data-2, echo = FALSE, out.width = "70%", fig.align = 'center', fig.cap = "A visual guide to customizing the import settings when loading a dataset into R using the 'Import Dataset' tab in RStudio."}
knitr::include_graphics("images/RStudio-window-data.png")
```
...
```{r R-objects, echo = FALSE, out.width = "60%", fig.align = 'center', fig.cap = "A visual guide to different types of data structures in R."}
...
```{r run-chunk, echo = FALSE, out.width = "90%", fig.align = 'center', fig.cap = "Executing a code chunk in R Markdown using the 'Run' button in RStudio."}
knitr::include_graphics("images/run-chunk.png")
```
