...
knitr::include_graphics("images/ch12_net_brain.png")
```
...
knitr::include_graphics("images/ch12_net_1.png")
```
...
knitr::include_graphics("images/ch12_net_reg.png")
```
...
knitr::include_graphics("images/ch12_net_large.png")
```
...
```{r active-fun-comparison, echo = FALSE, out.width = "80%", fig.align = 'center', fig.cap = "Comparison of common activation functions: sigmoid, tanh, and ReLU."}
x_values <- seq(-5, 5, by = 0.001)
sigmoid <- 1 / (1 + exp(-x_values))
tanh <- tanh(x_values)
relu <- pmax(0, x_values)

data <- data.frame(x = x_values, Sigmoid = sigmoid, Tanh = tanh, ReLU = relu)

ggplot(data) +
  geom_line(aes(x = x, y = Sigmoid, color = "Sigmoid"), size = 1.2) +
  geom_line(aes(x = x, y = Tanh, color = "Tanh"), size = 1.2) +
  geom_line(aes(x = x, y = ReLU, color = "ReLU"), size = 1.2) +
  scale_color_manual(name = "Activation Functions", 
                     values = c("Sigmoid" = "blue", "Tanh" = "green", "ReLU" = "red")) +
