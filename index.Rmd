...
This is the online home of a book *Data Science Foundations and Machine Learning Using R* provides an intuitive and practical introduction to the exciting field of Data Science—no prior analytics or programming experience required.

Inspired by the Free and Open Source Software movement, the content of this book is open and transparent, ensuring reproducibility. The code, datasets, and materials are hosted on [CRAN](https://cran.r-project.org/web/packages/liver/index.html) and are accessible via the **liver** package (<https://CRAN.R-project.org/package=liver>), allowing readers to engage with the book interactively.  
...
The online version of the book is hosted at [https://uncovering-data-science.netlify.app](https://uncovering-data-science.netlify.app) and kept up-to-date by [GitHub repository for this site](https://github.com/RezaMoammadi/Book-Data-Science).

### Work in Progress {-} 

This book is a work in progress, and we welcome feedback from readers. If you have any comments, suggestions, or corrections, please feel free to contact us at [Contact Us](mailto:a.mohammadi@uva.nl) or submitting a pull request with suggested changes at [GitHub](https://github.com/RezaMoammadi/Book-Data-Science). 
...
```{r data-table, echo = FALSE, fig.align = 'center', fig.cap = "List of datasets used in this book."}
datasets = data.frame( 
...
kbl(datasets, booktabs = T, caption = "List of datasets used for case studies in different chapters. Available in the R package liver.") %>%
