...
```{r, echo = F}
# Possible name for book:
#    Mastering Machine Learning: A Hands-On Approach with R
#.   From Data to Decisions: A Guide to Machine Learning with R
#    Data Science Foundations and Machine Learning Using R
#    Data Science and Machine Learning with R
# link for book: https://uncovering-data-science.netlify.app
...
datasets = data.frame( 
  ...
  Chapter = c("Chapters 4, 6, 7, 8, 10", "Chapter 7, 12", "Chapter 11", "Chapter 9", "Chapter 10", "Chapter 10", "Chapter 3", "Chapter 13")
)
