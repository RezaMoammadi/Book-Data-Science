...
```{r scatter-plot-ex-drug, echo = FALSE, out.width = "85%", fig.align = 'center', fig.cap = "Scatter plot of Age vs. Sodium/Potassium Ratio for 200 patients, with drug type indicated by color and shape."}
...
```{r scatter-plot-ex-drug-2, echo = FALSE, out.width = "85%", fig.align = 'center', fig.cap = "Scatter plot of Age vs. Sodium/Potassium Ratio for 200 patients, with drug type indicated by color and shape. The three new patients are represented by large orange circles."}
