...
```{r EDA-fig-2, echo = FALSE, out.width = "100%", fig.cap = "Animated scatter plot of fertility rate and life expectancy at birth for different regions of the world from 1960 to 2015."}
