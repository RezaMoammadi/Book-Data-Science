...
```{r Data-Science, fig.show='hold', echo = FALSE, out.width = "50%", fig.align = 'center', fig.cap = "Data science is a multidisciplinary field that applies computational and statistical methods to extract insights from data."}
...
```{r DIKW-Pyramid, fig.show='hold', echo = FALSE, out.width = "40%", fig.align = 'center', fig.cap = "The DIKW Pyramid illustrates the transformation of raw data into actionable insights, progressing from data to information, knowledge, and ultimately wisdom."}  
knitr::include_graphics("images/DIKW-Pyramid.png")  
```  
...
```{r CRISP-DM, echo = FALSE, fig.show='hold', out.width="60%", fig.align = 'center', fig.cap = "The Data Science Workflow is an iterative framework for structuring data science and machine learning projects. Inspired by the CRISP-DM model, it ensures systematic problem-solving and continuous refinement."}  
knitr::include_graphics("images/DSW.png")  
```  
