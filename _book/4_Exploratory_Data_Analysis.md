...
\caption{Animated scatter plot of fertility rate and life expectancy at birth for different world regions from 1960 to 2015.}(\#fig:EDA-fig-2)
\end{figure}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4_Exploratory_Data_Analysis_files/figure-latex/unnamed-chunk-4-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4_Exploratory_Data_Analysis_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4_Exploratory_Data_Analysis_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{4_Exploratory_Data_Analysis_files/figure-latex/unnamed-chunk-17-1} \end{center}
